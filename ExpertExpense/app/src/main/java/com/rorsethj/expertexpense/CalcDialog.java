...
public class CalcDialog extends DialogFragment {
    ...
    Dialog onCreateDialog(Bundle state) {
        ...
        @SuppressLint("InflateParams") final View view = inflater.inflate(R.layout.calculator_dialog, null);
            ...
            public void onClick(View v) {
                ...
                if (error == ERROR_NONE) {
                    ...
                    if (getTargetFragment() != null) {
                        System.out.println(">> Sending to a fragment");
                        ...
                        System.out.println(">> Sending to an activity");
                        try {
